...
export default function Settings() {
  ...
  const [form, setForm] = useState({
    ...
    meta_description: 'Portofolio UI/UX Designer & Front-End Developer Muhammad Azizi Abdillah. Mahasiswa Informatika UNU Yogyakarta.',
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>, field: 'home_image_url' | 'about_image_url') => {
    ...
    <AdminLayout title="Profil & Pengaturan">
      <div className="max-w-4xl mx-auto pb-12">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="font-sans font-semibold text-2xl" style={{ color: 'var(--color-ink)', letterSpacing: '-0.02em' }}>
              Profil &amp; Pengaturan
            </h2>
            <p className="text-xs mt-1" style={{ color: 'var(--color-muted)' }}>
              Kelola informasi profil, bio tentang saya, status magang, dan foto tampilan website.
            </p>
          </div>
          ...
          <form onSubmit={handleSave} className="flex flex-col gap-8">
            ...
            >
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="font-mono text-xs tracking-widest uppercase font-semibold" style={{ color: 'var(--color-ink)', letterSpacing: '0.12em' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="flex flex-col gap-1.5">
                  <label className="font-mono text-xs tracking-wider uppercase" style={{ color: 'var(--color-muted)' }}>
                    Nama Lengkap
                  </label>
                  <input
                    type="text"
                ...
                <div className="md:col-span-2 flex flex-col gap-1.5">
                  ...
                  />
                  <p className="text-[11px] mt-0.5" style={{ color: 'var(--color-muted)' }}>
                    Tampil sebagai headline besar di bagian paling atas halaman Beranda.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                />
                <p className="text-[11px] mt-0.5" style={{ color: 'var(--color-muted)' }}>
                  Paragraf ini tampil di bagian Hero Beranda dan di halaman Tentang Saya.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col gap-3">
                  <span className="font-mono text-xs font-semibold tracking-wider uppercase" style={{ color: 'var(--color-ink)' }}>
                    Foto Hero (Beranda)
                  </span>
                  <div
                  ...
                  >
                    {form.home_image_url ? (
                      <img src={form.home_image_url} alt="Hero" className="w-full h-full object-cover" />
                    ) : (
                      <span className="text-xs font-mono text-gray-400">Belum ada foto</span>
                    )}
                  </div>
                  <div className="flex items-center gap-2">
                    <label className="cursor-pointer inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-mono font-semibold uppercase border bg-white hover:bg-gray-50 transition-colors" style={{ borderColor: 'var(--color-border)', borderRadius: 'var(--radius-sm)' }}>
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <input
                    ...
                    onChange={(e) => setForm({ ...form, home_image_url: e.target.value })}
            ...
            <div className="flex items-center justify-between pt-2">
              <p className="text-xs" style={{ color: 'var(--color-muted)' }}>
                Perubahan akan langsung disinkronkan ke halaman Beranda, Tentang, dan Kontak.
              </p>
              <button
                type="submit"
                disabled={saving}
                ...
                style={{ backgroundColor: 'var(--color-ink)', color: 'var(--color-paper)', letterSpacing: '0.1em', borderRadius: 'var(--radius-sm)', fontFamily: 'var(--font-mono)' }}
              >
