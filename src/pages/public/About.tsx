          ...
          <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-start">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-0">
                <InfoRow
                  label="Lokasi"
                  value={profile?.location || "Yogyakarta, Indonesia"}
                />
                <InfoRow label="Status" value={availabilityText} />
                <InfoRow
                  label="Email"
                  value={profile?.email || "izzi.azizi29@gmail.com"}
                />
              </div>
            ...
            <div
              ...
              style={{
                ...
                borderRadius: "4px 36px 4px 36px",
        ...
        >
          <div className="max-w-[1440px] mx-auto px-6 md:px-16 py-20 md:py-24">
            ...
            <div className="grid md:grid-cols-2 gap-16 md:gap-20">
              ...
              <div>
                <h3
                  className="font-sans font-bold text-xl mb-8"
        ...
        <section style={{ backgroundColor: "var(--color-ink)" }}>
          <div className="max-w-[1440px] mx-auto px-6 md:px-16 py-20 md:py-24">
            ...
            <div
              ...
              style={{ borderColor: "rgba(247,247,245,0.15)" }}
            >
              {Object.entries(skillsData).map(
                ([cat, list]: [string, any], i) => (
                  <div
                    key={cat}
                    className="py-10"
                    style={{
                      borderRight:
                        i < 2 ? "1px solid rgba(247,247,245,0.15)" : "none",
                  ...
                  >
                    ...
                    <ul className="flex flex-col gap-2.5">
                      {list.length === 0 ? (
                        <li
                          className="text-sm"
                          style={{ color: "rgba(247,247,245,0.75)" }}
                        >
                          -
                        </li>
                      ) : (
                        list.map((s: any) => (
                          <li
                            ...
                            style={{ color: "rgba(247,247,245,0.90)" }}
                          >
                            <span
                              className="w-1.5 h-1.5 rounded-full shrink-0"
                              style={{
                                backgroundColor: "rgba(247,247,245,0.5)",
                              }}
                            />
                            {s.name}
                          </li>
