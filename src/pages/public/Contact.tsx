...
export default function Contact() {
  ...
  const socials = [
    ...
    {
      label: "WhatsApp",
      value: "+62 858 7678 3442",
      href: `https://wa.me/${WHATSAPP_NUMBER}`,
    },
    {
      label: "GitHub",
      value: "github.com/mazizi29",
      href: "https://github.com/mazizi29",
    },
    {
      label: "LinkedIn",
      value: "linkedin.com/in/muhammad-azizi-7407a120b",
      href: "https://www.linkedin.com/in/muhammad-azizi-7407a120b/",
    },
    {
      label: "Instagram",
      value: "@mazizi29_",
        ...
        <section className="max-w-[1440px] mx-auto px-6 md:px-16 pt-36 md:pt-44 pb-20">
          <div className="mb-14">
            ...
            >
              ...
              memberikan yang terbaik untuk tim Anda.
            </p>
          </div>
              ...
              <div className="flex flex-col gap-0">
                {socials.map(({ label, value, href, download }) => (
                  <a
                    ...
                    download={
                      download ? "CV_Muhammad_Azizi_Abdillah.pdf" : undefined
                    }
